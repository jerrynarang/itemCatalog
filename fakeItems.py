...
Item2 = Items(name="Real Madrid Shirt",
               date=datetime.datetime.now(),
               description="Navex Navex Footbal Jersey Club Real Madrid White Full Sleeve Ket L Football Kit",
...
Item3 = Items(name="Chicken lollypop",
               date=datetime.datetime.now(),
               description="Chicken lollipop is an hors d'oeuvre popular in Indian Chinese cuisine. Chicken lollipop is, essentially a frenched chicken winglet, where in the meat is cut loose from the bone end and pushed down creating a lollipop appearance",
